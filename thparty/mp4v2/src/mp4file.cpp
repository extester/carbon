...
//printf("XXXXXXX: getSize: %lld, getPosition: %lld, size: %lld\n", GetSize(), GetPosition(), size);
        if( size < 8 )
            size = 0;
        else
            size -= 8;
...
#if 1
void MP4FileWithProvider::CreateWithProvider( const char* fileName,
